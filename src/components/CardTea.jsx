...
const CardTea = ({image, description, caption, text, id}) => {
  ...
  return (
    <div className="font-montserrat flex flex-col items-center w-[350px] shadow-[0px_4px_4px_rgba(0, 0, 0, 0.25)]
      h-[525px] pb-8 rounded-[10px] border-solid border-[.3px] border-[#000000] pt-2">
